...
State Lexer::getNextLexical(Token& next_token)
{
    ...
    if (!getNextChar(ch)) {
        ...
        next_token.info.line = this->line;
        next_token.info.col = this->col;
        ...
        switch (ch)
        {
            ...
            case '!':
                ...
                if (this->peek == '=') {
                    ...
                    next_token.tag = Tag::sb_not;
                break;
            default:
                return State::ERROR;
        }
        next_token.value = TAG2STR.at(next_token.tag);
    }
    return State::OK;
}
